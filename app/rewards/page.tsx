          ...
          >
            ...
            <div className="mt-4 flex items-center justify-between gap-3">
              ...
              <button
                ...
                className="group inline-flex items-center border border-[#1034b8] bg-[#1034b8] px-4 py-2 text-[11px] font-extrabold uppercase tracking-[0.14em] text-[#fff4de]"
              >
                <ButtonHoverLabel label="Redeem" className="leading-none" />
              </button>
            </div>
          </article>
        ))}
